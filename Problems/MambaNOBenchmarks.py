...
from MambaNOModule import MambaNO
...
#NOTE:
#All the training sets should be in the folder: /home/star/liwei/CNO/data/
...
class ShearLayerDataset(Dataset):
    def __init__(self, which="training", nf=0, training_samples = 750, s=64, in_dist = True):
        ...
        if in_dist:
            if self.s==64:
                self.file_data = "/home/star/liwei/CNO/data/NavierStokes_64x64_IN.h5" #In-distribution file 64x64               
            else:
                self.file_data = "/home/star/liwei/CNO/data/NavierStokes_128x128_IN.h5"   #In-distribution file 128x128
        else:
            self.file_data = "/home/star/liwei/CNO/data/NavierStokes_128x128_OUT.h5"  #Out-of_-distribution file 128x128
...
class ShearLayer:
    def __init__(self, network_properties, device, batch_size, training_samples, size, in_dist = True):
        ...
        depths = network_properties["depths"]

        torch.manual_seed(retrain)
        
        self.model = MambaNO(#in_dim  = 1 + 2*self.N_Fourier_F,     # Number of input channels.
                             in_size = self.in_size,                # Input spatial size
                             embed_dim = channel_multiplier,
                             depths = depths,
...
class SinFrequencyDataset(Dataset):
    def __init__(self, which="training", nf=0, training_samples = 1024, s=64, in_dist = True):
        ...
        file_data_train = "/home/star/liwei/CNO/data/PoissonData_64x64_IN.h5"
        ...
        #The file:
        if in_dist:
            self.file_data = "/home/star/liwei/CNO/data/PoissonData_64x64_IN.h5"
        else:
            self.file_data = "/home/star/liwei/CNO/data/PoissonData_64x64_OUT.h5"
        ...
        if s!=64:
            self.file_data = "/home/star/liwei/CNO/data/PoissonData_NEW_s" + str(s) + ".h5"
            self.start = 0
...
class WaveEquationDataset(Dataset):
    def __init__(self, which="training", nf=0, training_samples = 512, t = 5, s = 64, in_dist = True):
        ...
        # Note: Normalization constants for both ID and OOD should be used from the training set!
        #Load normalization constants from the TRAINING set:
        file_data_train = "/home/star/liwei/CNO/data/WaveData_64x64_IN.h5"
        self.reader = h5py.File(file_data_train, 'r')
        ...
        #Default file:       
        if in_dist:
            self.file_data = "/home/star/liwei/CNO/data/WaveData_64x64_IN.h5"
        else:
            self.file_data = "/home/star/liwei/CNO/data/WaveData_64x64_OUT.h5"
        ...
        self.s = s
        if s!=64:
            self.file_data = "/home/star/liwei/CNO/data/WaveData_24modes_s" + str(s) + ".h5"
            self.start = 0
...
class AllenCahnDataset(Dataset):
    def __init__(self, which="training", nf = 0, training_samples = 256, s=64, in_dist = True):
        ...
        # Note: Normalization constants for both ID and OOD should be used from the training set!
        # Load normalization constants from the TRAINING set:
        file_data_train = "/home/star/liwei/CNO/data/AllenCahn_64x64_IN.h5"
        self.reader = h5py.File(file_data_train, 'r')
        self.min_data = self.reader['min_u0'][()]
        self.max_data = self.reader['max_u0'][()]
        self.min_model = self.reader['min_u'][()]
        ...
        #Default file:
        if in_dist:
            self.file_data = "/home/star/liwei/CNO/data/AllenCahn_64x64_IN.h5"
        else:            
            self.file_data = "/home/star/liwei/CNO/data/AllenCahn_64x64_OUT.h5"
        self.reader = h5py.File(self.file_data, 'r')
...
class ContTranslationDataset(Dataset):
    def __init__(self, which="training", nf=0, training_samples = 512, s = 64, in_dist = True):
        ...
        #Default file:       
        if in_dist:
            self.file_data = "/home/star/liwei/CNO/data/ContTranslation_64x64_IN.h5"
        else:
            self.file_data = "/home/star/liwei/CNO/data/ContTranslation_64x64_OUT.h5"
...
class DiscContTranslationDataset(Dataset):
    def __init__(self, which="training", nf=0, training_samples = 512, s = 64, in_dist = True):
        ...
        if in_dist:
            self.file_data = "/home/star/liwei/CNO/data/DiscTranslation_64x64_IN.h5"
        else:
            self.file_data = "/home/star/liwei/CNO/data/DiscTranslation_64x64_OUT.h5"
...
class AirfoilDataset(Dataset):
    def __init__(self, which="training", nf=0, training_samples = 512, s = 128, in_dist = True):
        ...
        if in_dist:
            self.file_data = "/home/star/liwei/CNO/data/Airfoil_128x128_IN.h5"
        else:
            self.file_data = "/home/star/liwei/CNO/data/Airfoil_128x128_OUT.h5"
...
class DarcyDataset(Dataset):
    def __init__(self, which="training", nf=0, training_samples=256, insample=True):
        ...
        # Note: Normalization constants for both ID and OOD should be used from the training set!
        # Load normalization constants from the TRAINING set:
        file_data_train = "/home/star/liwei/CNO/data/Darcy_64x64_IN.h5"
        self.reader = h5py.File(file_data_train, 'r')
        self.min_data = self.reader['min_u0'][()]
        self.max_data = self.reader['max_u0'][()]
        self.min_model = self.reader['min_u'][()]
        ...
        if insample:
            self.file_data = "/home/star/liwei/CNO/data/Darcy_64x64_IN.h5"
        else:
            self.file_data = "/home/star/liwei/CNO/data/Darcy_64x64_OUT.h5"
